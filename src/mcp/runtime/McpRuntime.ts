...
export class McpRuntime {
  ...
  constructor(
    public readonly servers: NukemAIMcpServerSpec[],
  ...
  async listAllTools(): Promise<NukemAIMcpToolSpec[]> {
    const out: NukemAIMcpToolSpec[] = [];
  ...
  getInstructions(): NukemAIMcpServerInstructions[] {
    const out: NukemAIMcpServerInstructions[] = [];
    for (const client of this.clients.values()) {
      if (client.getStatus() !== "ready") continue;
  ...
  statuses(): NukemAIMcpClientStatusEntry[] {
