...
export function validateToolInput(input: unknown, schema: NukemAIToolInputSchema): NukemAIToolValidationResult {
...
function validateValue(
  value: unknown,
  schema: NukemAIJsonSchema,
  path: string,
  issues: NukemAIToolValidationIssue[],
): void {
