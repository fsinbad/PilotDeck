import type { NukemAIHookOutput, NukemAIHookSpecificOutput } from "../protocol/output.js";

export function parseHookOutput(stdout: string): NukemAIHookOutput {
...
function parseSpecificOutput(value: unknown): NukemAIHookSpecificOutput | undefined {
...
function parsePermissionDecision(value: unknown): NukemAIHookSpecificOutput["permissionDecision"] {
  return value === "allow" || value === "deny" || value === "ask" || value === "passthrough" ? value : undefined;
}

function parsePermissionRequestDecision(value: unknown): NukemAIHookSpecificOutput["decision"] {
  if (!isRecord(value)) {
    return undefined;
  }
