export {
  NUKEMAI_HOOK_EVENTS,
  NUKEMAI_NOT_APPLICABLE_LEGACY_HOOK_EVENTS,
  isNukemAIHookEvent,
  type NukemAIHookEvent,
  type NukemAINotApplicableLegacyHookEvent,
} from "./hooks/protocol/events.js";
export type { NukemAIHookBaseInput, NukemAIHookInput } from "./hooks/protocol/input.js";
export { createHookInput, toLegacyHookInput } from "./hooks/protocol/input.js";
export type {
  NukemAIHookAsyncOutput,
  NukemAIHookOutput,
  NukemAIHookSpecificOutput,
  NukemAIHookSyncOutput,
  NukemAIPermissionHookDecision,
} from "./hooks/protocol/output.js";
export type { NukemAIHookCommand, NukemAIHookMatcher, NukemAIHooksSettings } from "./hooks/protocol/settings.js";
...
export {
  CommandHookExecutor,
  NUKEMAI_HOOK_TIMEOUT_MS,
  NUKEMAI_SESSION_END_HOOK_TIMEOUT_MS,
...
export { HookExecutionEventBus, type NukemAIHookExecutionEvent } from "./hooks/events/HookExecutionEventBus.js";

export type { NukemAIPluginManifest } from "./plugins/protocol/manifest.js";
export type { NukemAIMarketplaceReference } from "./plugins/protocol/manifest.js";
export type { NukemAILoadedPlugin, NukemAIPluginSourceKind } from "./plugins/protocol/plugin.js";
export { resolveMarketplaceReference, type NukemAIMarketplaceResolution, type NukemAIPluginMarketplaceStatus } from "./plugins/protocol/marketplace.js";
...
export {
  ...
  type NukemAIMcpInstructionEntry,
  type NukemAIMcpServerStaticSpec,
